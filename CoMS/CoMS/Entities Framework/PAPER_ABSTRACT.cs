...
namespace CoMS.Entities_Framework
{
    ...
    public partial class PAPER_ABSTRACT
    {
        ...
        public Nullable<decimal> CONFERENCE_SESSION_TOPIC_ID_1 { get; set; }
        ...
        public Nullable<int> WORD_COUNT_OF_PAPER_ABSTRACT_1 { get; set; }
        public string KEYWORDS_1 { get; set; }
        public string FULL_PAPER_OR_WORK_IN_PROGRESS_1 { get; set; }
        public Nullable<decimal> TYPE_OF_STUDY_ID_1 { get; set; }
        public string TYPE_OF_STUDY_NAME_1 { get; set; }
        public string TYPE_OF_STUDY_NAME_EN_1 { get; set; }
        public Nullable<decimal> CONFERENCE_PRESENTATION_TYPE_ID_1 { get; set; }
        ...
        public Nullable<decimal> CONFERENCE_SESSION_TOPIC_ID_2 { get; set; }
        ...
        public Nullable<int> WORD_COUNT_OF_PAPER_ABSTRACT_2 { get; set; }
        public string KEYWORDS_2 { get; set; }
        public string FULL_PAPER_OR_WORK_IN_PROGRESS_2 { get; set; }
        public Nullable<decimal> TYPE_OF_STUDY_ID_2 { get; set; }
        public string TYPE_OF_STUDY_NAME_2 { get; set; }
        public string TYPE_OF_STUDY_NAME_EN_2 { get; set; }
        public Nullable<decimal> CONFERENCE_PRESENTATION_TYPE_ID_2 { get; set; }
        ...
        public Nullable<int> WORD_COUNT_OF_PAPER_ABSTRACT_3 { get; set; }
        public string KEYWORDS_3 { get; set; }
        public string FULL_PAPER_OR_WORK_IN_PROGRESS_3 { get; set; }
        public Nullable<decimal> TYPE_OF_STUDY_ID_3 { get; set; }
        public string TYPE_OF_STUDY_NAME_3 { get; set; }
        public string TYPE_OF_STUDY_NAME_EN_3 { get; set; }
        public Nullable<decimal> CONFERENCE_PRESENTATION_TYPE_ID_3 { get; set; }
        ...
        public Nullable<int> WORD_COUNT_OF_PAPER_ABSTRACT_4 { get; set; }
        public string KEYWORDS_4 { get; set; }
        public string FULL_PAPER_OR_WORK_IN_PROGRESS_4 { get; set; }
        public Nullable<decimal> TYPE_OF_STUDY_ID_4 { get; set; }
        public string TYPE_OF_STUDY_NAME_4 { get; set; }
        public string TYPE_OF_STUDY_NAME_EN_4 { get; set; }
        public Nullable<decimal> CONFERENCE_PRESENTATION_TYPE_ID_4 { get; set; }
        ...
        public Nullable<int> WORD_COUNT_OF_PAPER_ABSTRACT_5 { get; set; }
        public string KEYWORDS_5 { get; set; }
        public string FULL_PAPER_OR_WORK_IN_PROGRESS_5 { get; set; }
        public Nullable<decimal> TYPE_OF_STUDY_ID_5 { get; set; }
        public string TYPE_OF_STUDY_NAME_5 { get; set; }
        public string TYPE_OF_STUDY_NAME_EN_5 { get; set; }
        public Nullable<decimal> CONFERENCE_PRESENTATION_TYPE_ID_5 { get; set; }
        ...
        public Nullable<bool> PAPER_ABSTRACT_WITHDRAWN { get; set; }
        public string PAPER_ABSTRACT_WITHDRAWN_SCRIPT { get; set; }
        public Nullable<System.DateTime> PAPER_ABSTRACT_WITHDRAWN_DATE { get; set; }
        public string PAPER_ABSTRACT_WITHDRAWN_NOTE { get; set; }
        public Nullable<bool> FINAL_APPROVAL_OR_REJECTION_OF_PAPER_ABSTRACT { get; set; }
        public string FINAL_APPROVAL_OR_REJECTION_OF_PAPER_ABSTRACT_SCRIPT { get; set; }
        public Nullable<System.DateTime> FINAL_APPROVAL_OR_REJECTION_OF_PAPER_ABSTRACT_DATE { get; set; }
        public Nullable<decimal> FINAL_APPROVAL_OR_REJECTION_OF_PAPER_ABSTRACT_REVIEWER_PERSON_ID { get; set; }
        public Nullable<decimal> ASSIGNED_CONFERENCE_SESSION_TOPIC_ID { get; set; }
